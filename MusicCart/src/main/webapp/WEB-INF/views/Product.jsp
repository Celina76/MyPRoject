...
<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" name="Product_name"
						...
						path="product_name"> <span class="help-block">
					</span>
				</div>
			</div>
<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" name="description"
						...
						path="description"> <span class="help-block">
					</span>
				</div>
			</div>
<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" name="supplier_name"
						...
						path="supplier_name"> <span class="help-block">
					</span>
				</div>
			</div>
...
<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" name="category_name"
						...
						path="category_name"> <span class="help-block">
					</span>
				</div>
			</div>
<div class ="form-group">
<label class="col-md-4 control-label" for="textinput">File to upload:</label>
<div class="col-md-4">
 <input type="file" name="image" placeholder="select the image" class="form-control input-md"
						path="image" >
...
<a href="display">view products page</a>
