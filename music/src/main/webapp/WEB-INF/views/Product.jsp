	...
	<div class="container"> 
				...
				<div class="col-md-4"> 
					<form:input type="text" 
 						placeholder="Insert Product Name" class="form-control input-md" 
 						 required="true" path="product_name"/> 
		...
		<form:errors path="product_name" cssClass="error"/> 
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<form:input type="text" 
						placeholder="enter price" class="form-control input-md"
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<form:input type="text" 
						placeholder="Enter Quantity" class="form-control input-md"
						required="true" path="quantity" />
					<span class="help-block"> </span>
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="supplier_name"
					>Supplier name</label>
				<div class="col-md-4">
					<form:input type="text" 
						placeholder="Supplier name" class="form-control input-md"
						required="true" path="supplier_name" />
					<span class="help-block"> </span>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<form:input type="text" 
						...
						required="true" path="category_name" />
					<span class="help-block"> </span>
